...
- implementation patterns and file-path / crate references
...
5. Repo-authored documentation still uses half-width parentheses and half-width colons (per `AGENTS.md`).
