...
```
VERSION=0.9.0; TARGET=x86_64-unknown-linux-gnu
...
```
docker plugin install --alias imbh ghcr.io/moriyoshi/imbh-log-driver:0.9.0-amd64   # or -arm64
